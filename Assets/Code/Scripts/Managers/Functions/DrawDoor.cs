...
public class DrawDoor : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            print("1111AAAAAAAAAAA " + Time.deltaTime);
            ...
            if (position != null)
            {
                ...
                print("END Difference DOOR " + Time.deltaTime);
    ...
    Tuple<GameObject, Solid> DrawHole3D(Vector3 pos, Quaternion rotation, float width, float height)
    {
        ...
        pos = new Vector3(pos.x, activeFloorDoma.LevelBottom + height / 2, pos.z);
